...
const Paginate = ({content}) => {
  ...
  return (
   ...
   <div className="w-1/2 m-1 sm:m-4">   
 ...
 <Image  
       ...
       />
          ...
          <div className="w-full m-1 sm:m-4 p-4">
    
            <Link href={`/news/${path.split('/')[2]}/${itx.node?.slug}`}><h2 className="text-2xl py-2 font-bold">{itx.node.title}</h2></Link>
       ...
       <div className="bg-gray-600 max-w-max flex flex-wrap"> { itx.node?.contentTags.nodes.map((tx ,index)=> 
