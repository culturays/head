...
const News = ({newsData}) => {
 ...
 const news11_name = newsData[10]?.name
  ...
  return (
    ...
    <div className="bg-white mx-2 px-2 lg:mx-8 ">
...
className='rounded-xl'
  ...
  alt={xy?.featuredImage?.node.altText }
      />
      <div>
   <Link href={`/news/article/${xy.slug}`}><h2 className='text-2xl font-bold py-3 text-gray-800 hover:text-gray-700'>{xy.title} </h2></Link>
   <div dangerouslySetInnerHTML={{__html:xy.excerpt}} className="leading-8"/>
 </div>
  <div className='flex text-gray-600 py-3'>
  ...
  <Link href={`/news/article/${xy.slug}`}><h2 className="text-gray-800 hover:text-gray-700 text-lg font-bold overflow-hidden text-ellipsis hover:text-gray-500 py-1"style={{ display: '-webkit-box', WebkitLineClamp:2, WebkitBoxOrient: 'vertical' }}>{xy.title}</h2></Link>
...
className='h-20 rounded-xl object-cover'
 ...
 <div className="px-2">
  ...
  <Link href={`/news/article/${xy.slug}`}><h2 className="text-gray-800 hover:text-gray-700 text-base font-bold overflow-hidden text-ellipsis hover:text-gray-500 py-1"style={{ display: '-webkit-box', WebkitLineClamp:2, WebkitBoxOrient: 'vertical' }}>{xy.title}</h2>
  </Link>
      <div className='py-2 text-sm flex flex-wrap '>
      <h3 className="m-1">{xy.articlesCategories.nodes[0].name} |</h3>
        <p className='m-1 text-gray-600'>{moment(xy.date).fromNow()}</p>
...
className='h-20 xxs:h-24 rounded-xl object-cover'
  ...
  <Link href={`/topic/${x1.contentTags.nodes[0].slug}/${x1.contentTags.nodes[0].id}`} ><h3 className='text-red-500 text-sm italic py-1'>{x1.contentTags.nodes[0].name} </h3></Link>
   <Link href={`/news/article/${x1.slug}`}><h2 className="text-gray-800 hover:text-gray-700 text-base font-bold overflow-hidden text-ellipsis hover:text-gray-500 py-1"style={{ display: '-webkit-box', WebkitLineClamp:2, WebkitBoxOrient: 'vertical' }}>{x1.title}</h2></Link>
   <div className='py-2 text-sm flex flex-wrap '>
...
className='h-32 xl:h-36 rounded-xl object-cover'
  ...
  <Link href={`/topic/${x1.contentTags.nodes[0].slug}/${x1.contentTags.nodes[0].id}`} ><h3 className='text-red-500 text-sm italic py-1'>{x1.contentTags.nodes[0].name} </h3></Link>
   <Link href={`/news/article/${x1.slug}`}><h2 className="text-gray-800 hover:text-gray-700 text-xl xl:text-base font-bold overflow-hidden text-ellipsis hover:text-gray-500 py-1"style={{ display: '-webkit-box', WebkitLineClamp:2, WebkitBoxOrient: 'vertical' }}>{x1.title}</h2></Link>
   <div className='py-2 text-sm flex flex-wrap '>
      <h3 className="m-1">{x1.articlesCategories.nodes[0].name} |</h3>
        <p className='m-1 text-gray-600'>{moment(x1.date).fromNow()} </p>
