...
import Link from "next/link";
  ...
  const ComingToNetflixClassDetails = ({coming_to_netflix_naija,  netflix_related, netflix_news, coming_to_netflix_details }) => {  
  ...
  <Image 
   ...
   <hr className='bg-black h-1 my-2'/>  
   <div >
   <div dangerouslySetInnerHTML={{__html:coming_to_netflix_details.content}} className="[&_p]:py-2 [&_iframe]:w-1/2 [&_figure>figcaption]:italic [&_figure>figcaption]:py-2 [&_figure>figcaption]:text-sm text-lg leading-9 [&_.wp-block-image>figure>img]:border-2 [&_.wp-block-image>figure>img]:border-black [&>h3]:text-3xl [&>h3]:font-bold [&>h2]:text-3xl [&>h5]:font-bold [&>h5]:text-xl [&>h2]:font-bold [&>h4]:text-3xl [&>h4]:font-bold [&_p>a]:hover:bg-green-900 [&_p>a]:text-green-600 py-0.5 [&>h5]:py-8 [&>h4]:py-8 [&>h2]:py-8 [&>h3]:py-8 [&>h2]:bg-gray-700 [&>h3]:bg-gray-700 [&>h4]:bg-gray-700 [&>h2]:text-gray-200 [&>h3]:text-gray-200 [&>h4]:text-gray-200 [&>h2]:px-3 [&>h3]:px-3 [&>h4]:px-3 [&_img]:m-auto [&_.wp-block-media-text]:sm:flex [&_.wp-block-media-text]:border [&_.wp-block-media-text>div>p]:px-2 [&_.wp-block-media-text>figure>img]:max-w-72 [&_.wp-block-media-text>figure>img]:py-4 [&_.wp-block-media-text>figure>img]:px-2"/> 
...
/>   
  ...
  export default ComingToNetflixClassDetails